...
def get_intermediate_results(plaintext, key):
    # 获取加密过程中的中间计算结果
    key1, key2, key3 = key_process(key)
    ...
    round_key_addition = xor(plaintext, key1)
    # 中间计算结果
    round_part_s00 = s_box1(round_key_addition[:4])
    round_part_s10 = s_box1(round_key_addition[4:8])
    round_part_s01 = s_box1(round_key_addition[8:12])
    round_part_s11 = s_box1(round_key_addition[12:])
    S00 = xor(multiply(1, round_part_s00), multiply(4, round_part_s10))
    S10 = xor(multiply(4, round_part_s00), multiply(1, round_part_s10))
    S01 = xor(multiply(1, round_part_s01), multiply(4, round_part_s11))
    S11 = xor(multiply(4, round_part_s01), multiply(1, round_part_s11))
    first_round_results = xor(np.concatenate((S00, S10, S01, S11)), key2)
    ...
    round_part_s2_01 = s_box1(round_part2_01)
    round_part_s2_11 = s_box1(round_part2_11)
    second_round_results = xor(np.concatenate((round_part_s2_00, round_part_s2_10, round_part_s2_01, round_part_s2_11)), key3)
    
    return first_round_results, second_round_results
